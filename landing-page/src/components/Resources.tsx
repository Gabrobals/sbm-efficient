...
const icons = {
  ...
  vscode: (
    <svg className="w-8 h-8 text-vs-blue" viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.583 2.995L12.2 7.398l-4.7-3.61L3.5 5.596v12.808l4 1.804 4.7-3.61 5.383 4.404 3.917-1.81V4.805l-3.917-1.81zm-2.083 12.61l-3.5-2.696v-5.818l3.5-2.696v11.21z"/>
    </svg>
  ),
  whitepaper: (
  ...
  blog: (
    <svg className="w-8 h-8 text-vs-orange" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 2.25M16.5 7.5V18a2.25 2.25 0 002.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 002.25 2.25h13.5M6 7.5h3v3H6v-3z" />
    </svg>
  ),
  demo: (
    <svg className="w-8 h-8 text-vs-pink" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export default function Resources() {
  ...
  const resources = [
    ...
    {
      typeKey: 'demoType' as const,
      titleKey: 'demoTitle' as const,
      descKey: 'demoDesc' as const,
      link: 'https://huggingface.co/spaces/Gabrobals/adaptive-k-demo',
      icon: icons.demo,
    },
    {
    ...
    {
      typeKey: 'vscodeType' as const,
      titleKey: 'vscodeTitle' as const,
      descKey: 'vscodeDesc' as const,
      link: 'https://open-vsx.org/extension/vertexdata/adaptive-k-toolkit',
      icon: icons.vscode,
    },
  ]
