...
\begin{enumerate}
    ...
    \item \textbf{Efficiency gains}: 30-50\% compute reduction with no quality degradation
...
Full implementation available at: \url{https://github.com/sbm-efficient/adaptive-k-routing}
