...
\begin{table}[t]
\centering
\caption{Threshold sensitivity on Mixtral 8x7B. Lower thresholds increase savings but with slight quality tradeoff.}
\label{tab:ablation}
\begin{tabular}{@{}ccc@{}}
\toprule
\textbf{Thresholds $[\theta_1, \theta_2]$} & \textbf{Compute} & \textbf{PPL $\Delta$} \\
\midrule
$[0.8, 1.2]$ (aggressive) & 71\% & +0.12 \\
$[1.0, 1.5]$ (balanced) & 89\% & +0.05 \\
$[1.3, 1.7]$ (conservative) & 105\% & +0.01 \\
\bottomrule
\end{tabular}
\end{table}
